...
/**
 * CompleteSessionAndUpdateOrderRequest Class Doc Comment
 *
 * @category Class
 * @description CompleteSessionAndUpdateOrderRequest is send as a final request. Either customer or customer_info needs to be present and have all customer data.
 * @package  COS\Swagger
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompleteSessionAndUpdateOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompleteSessionAndUpdateOrderRequest';
